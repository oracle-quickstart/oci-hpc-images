...
variable "features" {
  type    = string
  default = "RHCK-OFED-24.10-1.1.4.0-AMD-ROCM-711"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_2410_1140_el810", "hpcx_2251", "openmpi_508", "amd_rocm_711", "ol8_rhck", "oca_155_OL", "lustre_client_215"]
}
