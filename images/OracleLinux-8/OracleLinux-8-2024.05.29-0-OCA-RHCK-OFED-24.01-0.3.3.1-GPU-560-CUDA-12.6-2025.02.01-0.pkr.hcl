...
variable "image_base_name" {
  type    = string
  default = "OracleLinux-8.9-2024.05.29-0-OCA-RHCK-OFED-23.10-0.5.5.0-GPU-560-CUDA-12.6-2025.02.01-0"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_2310_2131", "hpcx_2180", "openmpi_414", "nvidia_560", "nvidia_cuda_12_6", "ol8_rhck" , "use_plugins" ]
}
