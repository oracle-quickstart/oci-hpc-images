...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_321", "hpcx_2251", "openmpi_508", "nvidia_open_580", "nvidia_cuda_13_0", "ol8_rhck", "oca_155_OL", "lustre_client_215"]
}
