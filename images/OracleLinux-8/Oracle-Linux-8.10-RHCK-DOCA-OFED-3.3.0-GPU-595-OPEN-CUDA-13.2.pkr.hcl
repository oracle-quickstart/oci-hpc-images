...
variable "base_image_name" {
  type    = string
  default = "Oracle-Linux-8.10-2026.06.15-1"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_330", "hpcx_2251", "openmpi_510", "nvidia_open_595", "nvidia_cuda_13_2", "ol8_rhck", "oca_161_beta_OL", "lustre_client_215"]
}
