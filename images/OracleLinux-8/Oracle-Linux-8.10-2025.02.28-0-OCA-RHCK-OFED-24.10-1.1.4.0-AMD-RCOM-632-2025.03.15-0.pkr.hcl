...
variable "base_image_name" {
  type    = string
  default = "Oracle-Linux-9.5-2025.01.31-0"
}

variable "image_base_name" {
  type    = string
  default = "Oracle-Linux-8.10-2025.02.28-0-OCA-RHCK-OFED-24.10-1.1.4.0-AMD-RCOM-632-2025.03.17-0"
}

variable "image_id" {
  type    = string
  default = "ocid1.image.oc1.us-chicago-1.aaaaaaaav3qwu4cc5g3h2xlxrfj3ntwbyhncxwkjlizlnewm22ycfj3jo3pa"
}
