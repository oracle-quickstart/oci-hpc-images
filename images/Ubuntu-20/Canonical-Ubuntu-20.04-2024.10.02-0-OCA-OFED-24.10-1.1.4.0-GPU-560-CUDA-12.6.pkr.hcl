...
variable "features" {
  type    = string
  default = "OCA-RHCK-OFED-24.10-1.1.4.0-GPU-570-CUDA"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_2410_1140", "hpcx_2181", "openmpi_414", "nvidia_560", "nvidia_cuda_12_6" , "use_plugins" , "kernel_5.15.0_131", "oca_150_ubuntu"]
}
