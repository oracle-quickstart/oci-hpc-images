...
variable "base_image_name" {
  type    = string
  default = "Canonical-Ubuntu-22.04-2025.07.23-0"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_310", "hpcx_223", "openmpi_508", "nvidia_open_580", "nvidia_cuda_13_0", "oca_153_ubuntu"]
}
