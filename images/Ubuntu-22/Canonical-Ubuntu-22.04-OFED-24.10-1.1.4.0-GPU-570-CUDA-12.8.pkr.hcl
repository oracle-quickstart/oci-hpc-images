...
variable "base_image_name" {
  type    = string
  default = "Canonical-Ubuntu-22.04-2025.01.31-1"
}
...
variable "features" {
  type    = string
  default = "OFED-24.10-1.1.4.0-GPU-570-CUDA-12.8"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_2410_1140", "hpcx_2212", "openmpi_414", "nvidia_570", "nvidia_cuda_12_8", "oca_151_ubuntu"]
}
