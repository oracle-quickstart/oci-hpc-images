...
variable "features" {
  type    = string
  default = "DOCA-OFED-3.1.0-GPU-590-OPEN-CUDA-13.1"
}
...
variable "build_options" {
  type    = string
  default = "noselinux,nomitigations,openmpi,benchmarks,nvidia,enroot,monitoring,networkdevicenames,use_plugins,stable_dcgm,lustre_client,oke"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_310", "hpcx_2251", "openmpi_508", "nvidia_open_590", "nvidia_cuda_13_1", "oca_155_ubuntu", "lustre_client_215"]
}
