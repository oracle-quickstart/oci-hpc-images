...
variable "features" {
  type    = string
  default = "DOCA-OFED-3.2.1-AMD-ROCM-72"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_321", "hpcx_2251", "openmpi_508", "amd_rocm_72", "oca_157_beta_ubuntu", "lustre_client_215"]
}
