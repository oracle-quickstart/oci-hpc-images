...
variable "features" {
  type    = string
  default = "DOCA-OFED-3.1.0-GPU-570-OPEN-CUDA-12.8"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_310", "hpcx_2212", "openmpi_508", "nvidia_open_570", "nvidia_cuda_12_8", "oca_152_ubuntu"]
}
