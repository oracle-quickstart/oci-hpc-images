...
variable "features" {
  type    = string
  default = "DOCA-OFED-3.2.1-GPU-580-OPEN-CUDA-13.0"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_321", "hpcx_2251", "openmpi_508", "nvidia_open_580", "nvidia_cuda_13_0", "oca_157_beta_ubuntu", "lustre_client_215"]
}
