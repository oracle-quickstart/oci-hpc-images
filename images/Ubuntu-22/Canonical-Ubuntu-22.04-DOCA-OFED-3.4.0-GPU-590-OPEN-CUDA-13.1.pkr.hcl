...
variable "features" {
  type    = string
  default = "KERNEL-ORACLE-6.8-DOCA-OFED-3.4.0-GPU-590-OPEN-CUDA-13.1"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_340", "hpcx_2251", "openmpi_510", "nvidia_open_590", "nvidia_cuda_13_1", "oca_161_beta_ubuntu", "kernel-oracle-6.8", "packages_kmod_upgrade", "lustre_client_215"]
}
