...
variable "features" {
  type    = string
  default = "DOCA-OFED-3.1.0-GPU-575-OPEN-CUDA-12.9"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_310", "hpcx_223", "openmpi_508", "nvidia_open_575", "nvidia_cuda_12_9", "oca_153_ubuntu"]
}
