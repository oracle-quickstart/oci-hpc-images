...
variable "features" {
  type    = string
  default = "OCA-OFED-24.10-1.1.4.0-GPU-570-OPEN-CUDA-12.8"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_2410_1140", "hpcx_2212", "openmpi_414", "nvidia_open_570", "nvidia_cuda_12_8", "oca_150_ubuntu"]
}
