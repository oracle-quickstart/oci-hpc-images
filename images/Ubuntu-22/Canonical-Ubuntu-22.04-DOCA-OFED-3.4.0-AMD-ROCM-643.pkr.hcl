...
variable "features" {
  type    = string
  default = "KERNEL-ORACLE-6.8-DOCA-OFED-3.4.0-AMD-ROCM-643"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_340", "hpcx_2251", "openmpi_510", "amd_rocm_643", "oca_161_beta_ubuntu", "kernel-oracle-6.8", "packages_kmod_upgrade", "lustre_client_215"]
}
