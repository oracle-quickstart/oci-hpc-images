...
variable "features" {
  type    = string
  default = "KERNEL-RHCK-DOCA-OFED-3.3.0-GPU-595-OPEN-CUDA-13.2"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_330", "hpcx_2251", "openmpi_510", "nvidia_open_595", "nvidia_cuda_13_2", "ol9_rhck", "oca_161_beta_OL", "lustre_client_215"]
}
