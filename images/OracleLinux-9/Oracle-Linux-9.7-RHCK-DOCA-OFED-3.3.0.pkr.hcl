...
variable "features" {
  type    = string
  default = "KERNEL-RHCK-DOCA-OFED-3.3.0"
}
...
variable "build_options" {
  type    = string
  default = "noselinux,rhck,openmpi,networkdevicenames,use_plugins,lustre_client,occl_net_ib"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_330", "hpcx_2251", "openmpi_510", "ol9_rhck", "oca_161_beta_OL", "lustre_client_215"]
}
