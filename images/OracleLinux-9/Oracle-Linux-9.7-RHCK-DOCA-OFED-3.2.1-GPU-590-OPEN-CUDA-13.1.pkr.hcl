...
variable "base_image_name" {
  type    = string
  default = "Oracle-Linux-9.7-2026.02.28-0"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_321", "hpcx_2251", "openmpi_508", "nvidia_open_590", "nvidia_cuda_13_1", "ol9_rhck", "oca_155_OL", "lustre_client_215"]
}
