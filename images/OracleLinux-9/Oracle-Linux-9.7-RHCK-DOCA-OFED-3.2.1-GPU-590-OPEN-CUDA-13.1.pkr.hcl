...
variable "base_image_name" {
  type    = string
  default = "Oracle-Linux-9.7-2026.01.29-0"
}
...
variable "features" {
  type    = string
  default = "RHCK-DOCA-OFED-3.2.1-GPU-590-OPEN-CUDA-13.1"
}
...
variable "build_options" {
  type    = string
  default = "noselinux,rhck,openmpi,benchmarks,nvidia,monitoring,enroot,networkdevicenames,use_plugins,lustre_client"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_321", "hpcx_2251", "openmpi_508", "nvidia_open_590", "nvidia_cuda_13_1", "ol9_rhck", "oca_157_beta_OL", "lustre_client_215"]
}
