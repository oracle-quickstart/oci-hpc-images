...
variable "base_image_name" {
  type    = string
  default = "Oracle-Linux-9.6-2025.11.20-0"
}
...
variable "features" {
  type    = string
  default = "KERNEL-RHCK-DOCA-OFED-3.4.0-AMD-ROCM-643"
}
...
variable "build_options" {
  type    = string
  default = "noselinux,rhck,openmpi,benchmarks,amd,enroot,networkdevicenames,use_plugins,lustre_client,occl_net_ib"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_340", "hpcx_2251", "openmpi_510", "amd_rocm_643", "ol9_rhck", "oca_161_beta_OL", "lustre_client_215"]
}
