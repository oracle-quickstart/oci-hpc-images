...
variable "base_image_name" {
  type    = string
  default = "Oracle-Linux-9.7-2026.06.15-1"
}
...
variable "features" {
  type    = string
  default = "KERNEL-RHCK-DOCA-OFED-3.4.0-GPU-590-OPEN-CUDA-13.1"
}
...
variable "build_options" {
  type    = string
  default = "noselinux,rhck,openmpi,benchmarks,nvidia,monitoring,enroot,networkdevicenames,use_plugins,lustre_client,occl_net_ib"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_340", "hpcx_2251", "openmpi_510", "nvidia_open_590", "nvidia_cuda_13_1", "ol9_rhck", "oca_161_beta_OL", "lustre_client_215"]
}
...
source "oracle-oci" "oracle" {
  ...
  #base_image_ocid         = "ocid1.image.oc1.ca-montreal-1.aaaaaaaa2ypuhnls34zphh3b4x3bwutgh7jvrpdlsh6u2dgrczcft6qodwjq"
  shape               = var.shape
  shape_config {
