...
variable "features" {
  type    = string
  default = "RHCK-DOCA-OFED-3.1.0-AMD-ROCM-641"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_310_el95", "hpcx_2251", "openmpi_508", "amd_rocm_641", "ol9_rhck", "oca_155_OL", "lustre_client_215"]
}
