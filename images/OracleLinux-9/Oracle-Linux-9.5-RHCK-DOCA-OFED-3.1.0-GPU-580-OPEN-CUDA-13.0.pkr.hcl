...
variable "features" {
  type    = string
  default = "RHCK-DOCA-OFED-3.1.0-GPU-580-OPEN-CUDA-13.0"
}
...
variable "build_options" {
  type    = string
  default = "noselinux,rhck,openmpi,benchmarks,nvidia,monitoring,enroot,networkdevicenames,use_plugins,stable_dcgm,lustre_client"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_310_el95", "hpcx_2251", "openmpi_508", "nvidia_open_580", "nvidia_cuda_13_0", "ol9_rhck", "oca_155_OL", "lustre_client_215"]
}
