...
variable "features" {
  type    = string
  default = "DOCA-OFED-3.1.0-AMD-ROCM-632"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_310", "hpcx_2251", "openmpi_508", "amd_rocm_632", "oca_155_ubuntu", "lustre_client_216"]
}
