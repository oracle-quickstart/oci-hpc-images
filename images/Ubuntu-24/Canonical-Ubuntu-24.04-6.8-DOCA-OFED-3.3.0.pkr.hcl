...
variable "features" {
  type    = string
  default = "KERNEL-ORACLE-6.8-DOCA-OFED-3.3.0"
}
...
variable "build_options" {
  type    = string
  default = "noselinux,nomitigations,openmpi,networkdevicenames,use_plugins,lustre_client,oke,occl_net_ib"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_330", "hpcx_2251", "openmpi_510", "oca_161_beta_ubuntu", "kernel-oracle-6.8", "packages_kmod_upgrade", "lustre_client_215"]
}
