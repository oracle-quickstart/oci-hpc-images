...
variable "base_image_name" {
  type    = string
  default = "Canonical-Ubuntu-24.04-2025.01.31-1"
}
...
variable "features" {
  type    = string
  default = "DOCA-OFED-2.10.0-GPU-560-CUDA-12.6"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_2100", "hpcx_2212", "openmpi_414", "nvidia_560", "nvidia_cuda_12_6", "oca_151_ubuntu"]
}
