...
variable "features" {
  type    = string
  default = "6.14-DOCA-OFED-3.2.1-AMD-ROCM-72"
}
...
variable "build_options" {
  type    = string
  default = "noselinux,nomitigations,openmpi,benchmarks,amd,enroot,networkdevicenames,use_plugins,oke"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_321", "hpcx_2251", "openmpi_508", "amd_rocm_72", "oca_157_beta_ubuntu"]
}
