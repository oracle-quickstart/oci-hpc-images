...
variable "features" {
  type    = string
  default = "DOCA-OFED-3.0.0-GPU-560-CUDA-12.6"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_300", "hpcx_223", "openmpi_508", "nvidia_560", "nvidia_cuda_12_6", "oca_152_ubuntu"]
}
