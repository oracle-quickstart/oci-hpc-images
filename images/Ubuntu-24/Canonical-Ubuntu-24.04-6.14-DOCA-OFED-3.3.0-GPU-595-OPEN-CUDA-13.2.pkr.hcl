...
variable "features" {
  type    = string
  default = "KERNEL-ORACLE-6.14-DOCA-OFED-3.3.0-GPU-595-OPEN-CUDA-13.2"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_330", "hpcx_2251", "openmpi_510", "nvidia_open_595", "nvidia_cuda_13_2", "oca_161_beta_ubuntu", "kernel-oracle-6.14", "lustre_client_217", "packages_kmod_upgrade"]
}
