...
variable "features" {
  type    = string
  default = "6.14-DOCA-OFED-3.2.1-GPU-590-OPEN-CUDA-13.1"
}
...
variable "build_options" {
  type    = string
  default = "noselinux,nomitigations,openmpi,benchmarks,nvidia,enroot,monitoring,networkdevicenames,use_plugins,oke"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_321", "hpcx_2251", "openmpi_508", "nvidia_open_590", "nvidia_cuda_13_1", "oca_157_beta_ubuntu"]
}
