...
variable "features" {
  type    = string
  default = "6.8-DOCA-OFED-3.2.1-AMD-ROCM-643"
}
...
variable "build_options" {
  type    = string
  default = "noselinux,nomitigations,openmpi,benchmarks,amd,enroot,networkdevicenames,use_plugins,lustre_client,oke"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_321", "hpcx_2251", "openmpi_508", "amd_rocm_643", "oca_157_beta_ubuntu", "kernel_6.8.0-90", "lustre_client_215"]
}
