...
variable "features" {
  type    = string
  default = "KERNEL-NVIDIA-64K-6.17-DOCA-OFED-3.4.0-GPU-580-OPEN-CUDA-13.0"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_340", "hpcx_2251", "openmpi_510", "nvidia_open_580", "nvidia_cuda_13_0", "oca_157_beta_ubuntu", "kernel-nvidia-64k-6.17", "packages_kmod_upgrade"]
}
