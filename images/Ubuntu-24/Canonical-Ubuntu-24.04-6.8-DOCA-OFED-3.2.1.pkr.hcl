...
variable "build_options" {
  type    = string
  default = "noselinux,nomitigations,openmpi,networkdevicenames,use_plugins,lustre_client,oke"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_321", "hpcx_2251", "openmpi_508", "oca_157_beta_ubuntu","kernel_6.8.0-90", "lustre_client_215"]
}
