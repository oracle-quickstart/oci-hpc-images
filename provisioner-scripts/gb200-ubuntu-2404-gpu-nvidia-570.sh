...
# This script is adapted from OpenAI's GB200 image builder for azure images, for the Ubuntu 24.04 aarch64 base image.
...
NVIDIA_DRIVER_SEMANTIC_VERSION="570.158.01-0"
NVIDIA_FABRICMANAGER_VERSION="570.158.01-1"

KUBELOGIN_SHA="c22fb2bf48f894b2fa83226e25c4fba1a7945c6b"    # Current as of 05-14-2025
CONTAINERD_VERSION="1.7.24-0ubuntu1~24.04.2"                # Current as of 05-14-2025
...
install_nvidia_drivers () {
    ...
    apt-get install -y  libnvidia-cfg1-${NVIDIA_DRIVER_MAJOR_VERSION}=${NVIDIA_DRIVER_SEMANTIC_VERSION}ubuntu1 \
                        ...
                        libnvidia-nscq-${NVIDIA_DRIVER_MAJOR_VERSION}=${NVIDIA_FABRICMANAGER_VERSION} \
    ...
    apt-get install -y nvidia-imex-${NVIDIA_DRIVER_MAJOR_VERSION}=${NVIDIA_FABRICMANAGER_VERSION}
    ...
    apt-get install -y nvidia-fabricmanager-${NVIDIA_DRIVER_MAJOR_VERSION}=${NVIDIA_FABRICMANAGER_VERSION}
    apt-mark hold nvidia-fabricmanager-${NVIDIA_DRIVER_MAJOR_VERSION}
...
install_nvidia_dcgm_manager() {
    apt-get install -y datacenter-gpu-manager=1:3.3.9
